...
export class ContentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.hc
      .get<any[]>(`https://api.github.com/users/${JSON.parse(this.data1)}`)
      .subscribe((data) => {
        this.users = data;
    ...
    this.hc
      .get<any[]>(
        `https://api.github.com/users/${JSON.parse(this.data1)}/repos`
      )
      .subscribe((repos) => {
    ...
    this.hc
      .get<any[]>(
        `https://api.github.com/users/${JSON.parse(this.data1)}/followers`
      )
      .subscribe((data) => {
    ...
    this.hc
      .get<any[]>(
        `https://api.github.com/users/${JSON.parse(this.data1)}/following`
      )
      .subscribe((data) => {
